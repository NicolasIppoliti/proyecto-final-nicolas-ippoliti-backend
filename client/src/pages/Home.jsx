...
function Home() {
  ...
  useEffect(() => {
    ...
    axios.get('https://proyecto-final-nicolas-ippoliti-backend.onrender.com/api/products')
      .then(response => {
  ...
  const handleAddToCart = async (productId) => {
    try {
        ...
        const response = await axios.post(`https://proyecto-final-nicolas-ippoliti-backend.onrender.com/api/cart/${userId}/add/${productId}`, { productId }, {
      headers: {
  ...
  const handlePurchase = async (productId) => {
    try {
      ...
      const user = localStorage.getItem('user');
      const userId = JSON.parse(user).id;
      const response = await axios.post(`https://proyecto-final-nicolas-ippoliti-backend.onrender.com/api/cart/${userId}/add/${productId}`, {}, {
          headers: {
              'Authorization': `Bearer ${token}`
          }
      });
