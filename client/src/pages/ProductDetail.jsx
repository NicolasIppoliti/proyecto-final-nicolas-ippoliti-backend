...
function ProductDetail() {
  ...
  useEffect(() => {
    ...
    axios.get(`https://proyecto-final-nicolas-ippoliti-backend.onrender.com/api/products/${id}`)
      .then(response => {
  ...
  const handleAddToCart = async () => {
    try {
      ...
      await axios.post(`https://proyecto-final-nicolas-ippoliti-backend.onrender.com/api/cart/${userId}/add/${product.id}`, {
        headers: {
